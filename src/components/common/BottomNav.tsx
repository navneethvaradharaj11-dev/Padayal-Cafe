...
export function BottomNav() {
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-padayal-surface/95 backdrop-blur-md border-t border-padayal-bg shadow-organic-lg px-2 py-2">
